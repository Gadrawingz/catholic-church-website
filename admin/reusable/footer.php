        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright &copy; <?php echo date('Y'); ?> - All rights reserved</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Made with love</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
  ...
  <script src="../others/js/template.js"></script>
  <script src="../others/js/todolist.js"></script>
  <!-- endinject -->
